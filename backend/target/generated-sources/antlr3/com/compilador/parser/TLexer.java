...
public class TLexer extends Lexer {
	...
	public final void mCERRAR() throws RecognitionException {
		try {
			...
			// com\\compilador\\parser\\T.g:133:11: ( 'cerrar' )
			// com\\compilador\\parser\\T.g:133:13: 'cerrar'
			{
			match("cerrar"); 
	...
	public final void mNUMERICO() throws RecognitionException {
		try {
			int _type = NUMERICO;
			int _channel = DEFAULT_TOKEN_CHANNEL;
			// com\\compilador\\parser\\T.g:134:11: ( 'numeros' )
			// com\\compilador\\parser\\T.g:134:13: 'numeros'
			{
			match("numeros"); 
	...
	public final void mALFABETICO() throws RecognitionException {
		try {
			...
			int _channel = DEFAULT_TOKEN_CHANNEL;
			// com\\compilador\\parser\\T.g:135:11: ( 'letras' )
			// com\\compilador\\parser\\T.g:135:13: 'letras'
			{
			match("letras"); 
	...
	public final void mFECHA() throws RecognitionException {
		try {
			int _type = FECHA;
			int _channel = DEFAULT_TOKEN_CHANNEL;
			// com\\compilador\\parser\\T.g:136:11: ( 'fecha' )
			// com\\compilador\\parser\\T.g:136:13: 'fecha'
			{
			match("fecha"); 
	...
	public final void mTABLA() throws RecognitionException {
		try {
			int _type = TABLA;
			int _channel = DEFAULT_TOKEN_CHANNEL;
			// com\\compilador\\parser\\T.g:137:11: ( 'tabla' )
			// com\\compilador\\parser\\T.g:137:13: 'tabla'
			{
			match("tabla"); 
	...
	public final void mINICIO() throws RecognitionException {
		try {
			int _type = INICIO;
			int _channel = DEFAULT_TOKEN_CHANNEL;
			// com\\compilador\\parser\\T.g:138:11: ( 'inicio' )
			// com\\compilador\\parser\\T.g:138:13: 'inicio'
			{
			match("inicio"); 
	...
	public final void mFIN() throws RecognitionException {
		try {
			int _type = FIN;
			int _channel = DEFAULT_TOKEN_CHANNEL;
			// com\\compilador\\parser\\T.g:139:11: ( 'fin' )
			// com\\compilador\\parser\\T.g:139:13: 'fin'
			{
			match("fin"); 
	...
	public final void mUSAR() throws RecognitionException {
		try {
			int _type = USAR;
			int _channel = DEFAULT_TOKEN_CHANNEL;
			// com\\compilador\\parser\\T.g:140:11: ( 'usar' )
			// com\\compilador\\parser\\T.g:140:13: 'usar'
			{
			match("usar"); 
	...
	public final void mCREAR() throws RecognitionException {
		try {
			int _type = CREAR;
			int _channel = DEFAULT_TOKEN_CHANNEL;
			// com\\compilador\\parser\\T.g:141:11: ( 'crear' )
			// com\\compilador\\parser\\T.g:141:13: 'crear'
			{
			match("crear"); 
	...
	public final void mID() throws RecognitionException {
		try {
			int _type = ID;
			int _channel = DEFAULT_TOKEN_CHANNEL;
			// com\\compilador\\parser\\T.g:142:11: ( ( 'a' .. 'z' | 'A' .. 'Z' | '_' ) ( 'a' .. 'z' | 'A' .. 'Z' | '0' .. '9' | '_' )* )
			// com\\compilador\\parser\\T.g:142:13: ( 'a' .. 'z' | 'A' .. 'Z' | '_' ) ( 'a' .. 'z' | 'A' .. 'Z' | '0' .. '9' | '_' )*
			{
			...
			// com\\compilador\\parser\\T.g:142:37: ( 'a' .. 'z' | 'A' .. 'Z' | '0' .. '9' | '_' )*
			loop1:
			while (true) {
				int alt1=2;
	...
	public final void mWS() throws RecognitionException {
		try {
			int _type = WS;
			int _channel = DEFAULT_TOKEN_CHANNEL;
			// com\\compilador\\parser\\T.g:143:11: ( ( ' ' | '\\n' | '\\t' | '\\r' )+ )
			// com\\compilador\\parser\\T.g:143:13: ( ' ' | '\\n' | '\\t' | '\\r' )+
			{
			// com\\compilador\\parser\\T.g:143:13: ( ' ' | '\\n' | '\\t' | '\\r' )+
			int cnt2=0;
			loop2:
	...
	public void mTokens() throws RecognitionException {
		// com\\compilador\\parser\\T.g:1:8: ( CERRAR | NUMERICO | ALFABETICO | FECHA | TABLA | INICIO | FIN | USAR | CREAR | ID | WS )
		int alt3=11;
		switch ( input.LA(1) ) {
		case 'c':
			{
		...
		switch (alt3) {
			case 1 :
				// com\\compilador\\parser\\T.g:1:10: CERRAR
				{
				mCERRAR(); 
				...
				break;
			case 2 :
				// com\\compilador\\parser\\T.g:1:17: NUMERICO
				{
				mNUMERICO(); 
				...
				break;
			case 3 :
				// com\\compilador\\parser\\T.g:1:26: ALFABETICO
				{
				mALFABETICO(); 
				...
				break;
			case 4 :
				// com\\compilador\\parser\\T.g:1:37: FECHA
				{
				mFECHA(); 
				...
				break;
			case 5 :
				// com\\compilador\\parser\\T.g:1:43: TABLA
				{
				mTABLA(); 
				...
				break;
			case 6 :
				// com\\compilador\\parser\\T.g:1:49: INICIO
				{
				mINICIO(); 
				...
				break;
			case 7 :
				// com\\compilador\\parser\\T.g:1:56: FIN
				{
				mFIN(); 
				...
				break;
			case 8 :
				// com\\compilador\\parser\\T.g:1:60: USAR
				{
				mUSAR(); 
				...
				break;
			case 9 :
				// com\\compilador\\parser\\T.g:1:65: CREAR
				{
				mCREAR(); 
				...
				break;
			case 10 :
				// com\\compilador\\parser\\T.g:1:71: ID
				{
				mID(); 
				...
				break;
			case 11 :
				// com\\compilador\\parser\\T.g:1:74: WS
				{
				mWS(); 
